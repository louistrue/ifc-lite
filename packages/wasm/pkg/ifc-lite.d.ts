...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_942: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_499: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_945: (a: number, b: number, c: number, d: number) => void;
    ...
    readonly __wasm_bindgen_func_elem_943: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_500: (a: number, b: number) => void;
