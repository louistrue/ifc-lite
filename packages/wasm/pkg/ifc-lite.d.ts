...
export class MeshDataJs {
     ...
     */
    boundingBoxDimensions(): Float32Array;
    /**
 ...
 */
export function computeMeshQuantities(positions: Float32Array, indices: Uint32Array): any;
...
export interface InitOutput {
    ...
    readonly computeMeshQuantities: (a: number, b: number, c: number, d: number) => number;
    ...
    readonly meshdatajs_boundingBoxDimensions: (a: number, b: number) => void;
    ...
    readonly __wasm_bindgen_func_elem_1028: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_482: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_1033: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1066: (a: number, b: number, c: number, d: number) => void;
