...
export interface InitOutput {
  ...
  readonly __wasm_bindgen_func_elem_1068: (a: number, b: number, c: number) => void;
  readonly __wasm_bindgen_func_elem_1067: (a: number, b: number) => void;
  readonly __wasm_bindgen_func_elem_1108: (a: number, b: number, c: number, d: number) => void;
