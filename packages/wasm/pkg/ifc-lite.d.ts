...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_669: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_376: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_711: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_670: (a: number, b: number, c: number) => void;
