...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_124: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_1000: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_537: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_1003: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1265: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_125: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_1001: (a: number, b: number, c: number) => void;
