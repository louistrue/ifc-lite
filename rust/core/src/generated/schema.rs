...
impl IfcType {
    ...
    pub fn from_str(s: &str) -> Self {
        ...
        match upper.as_str() {
            ...
            "IFCDIRECTRIXDERIVEDREFERENCESWEPTAREASOLID" => Self::IfcDirectrixDerivedReferenceSweptAreaSolid,
            ...
            "IFCMOBILETELECOMMUNICATIONSAPPLIANCETYPE" => Self::IfcMobileTelecommunicationsApplianceType,
    ...
    pub fn as_str(&self) -> &'static str {
        match self {
            ...
            Self::IfcDirectrixDerivedReferenceSweptAreaSolid => "IFCDIRECTRIXDERIVEDREFERENCESWEPTAREASOLID",
            ...
            Self::IfcMobileTelecommunicationsApplianceType => "IFCMOBILETELECOMMUNICATIONSAPPLIANCETYPE",
    ...
    pub fn parent(&self) -> Option<Self> {
        match self {
            ...
            Self::IfcDirectrixDerivedReferenceSweptAreaSolid => Some(Self::IfcFixedReferenceSweptAreaSolid),
...
/// Simplified check: IFC prefix, not a TYPE template, not a relationship, not a property
pub fn has_geometry_by_name(type_name: &str) -> bool {
    type_name.starts_with("IFC") 
        && !type_name.ends_with("TYPE")
        && !type_name.starts_with("IFCREL")
        && !type_name.starts_with("IFCPROPERTY")
}
