...
export interface InitOutput {
  ...
  readonly __wasm_bindgen_func_elem_1269: (a: number, b: number, c: number) => void;
  readonly __wasm_bindgen_func_elem_1268: (a: number, b: number) => void;
  readonly __wasm_bindgen_func_elem_1307: (a: number, b: number, c: number, d: number) => void;
