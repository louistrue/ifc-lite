...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_1020: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_474: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_1025: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1058: (a: number, b: number, c: number, d: number) => void;
