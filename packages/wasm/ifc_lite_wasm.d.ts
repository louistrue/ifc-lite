...
export interface InitOutput {
  ...
  readonly __wasm_bindgen_func_elem_260: (a: number, b: number) => void;
  readonly __wasm_bindgen_func_elem_250: (a: number, b: number) => void;
  readonly __wasm_bindgen_func_elem_249: (a: number, b: number) => void;
  readonly __wasm_bindgen_func_elem_299: (a: number, b: number, c: number, d: number) => void;
