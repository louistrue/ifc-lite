...
export interface InitOutput {
  ...
  readonly __wasm_bindgen_func_elem_1070: (a: number, b: number, c: number) => void;
  readonly __wasm_bindgen_func_elem_1069: (a: number, b: number) => void;
  readonly __wasm_bindgen_func_elem_1110: (a: number, b: number, c: number, d: number) => void;
