      ...
      <Tabs defaultValue="properties" className="flex-1 flex flex-col overflow-hidden">
        ...
        >
          <TabsTrigger
            ...
            className="tab-trigger flex-1 min-w-0 rounded-none border-b-2 border-transparent data-[state=active]:border-primary uppercase text-[11px] tracking-wide h-full px-2 transition-all"
          >
            {compactTabs ? (
          ...
          >
            {compactTabs ? (
              ...
              <span className="truncate">Quantities</span>
            )}
          </TabsTrigger>
          <TabsTrigger
            value="bsdd"
          ...
          >
            {compactTabs ? (
              ...
              <span className="truncate">bSDD</span>
            )}
          </TabsTrigger>
        </TabsList>
